<?php 
	...
	if (!isset($action)) {
		...
		if ($action == 1) {
			...
			$_SESSION['news_1'][0] = 'US growth faster than expected';
			$_SESSION['news_1'][1] = 'index.php?menu=' . $menu . '&action=1';
			print '
			...
			# inicijalizacija sjednice
			$_SESSION['news_2'][0] = 'Wall Street: Tech firm markets higher surge pushes US';
			$_SESSION['news_2'][1] = 'index.php?menu=' . $menu . '&action=2';
			
			print '
			<h2>Wall Street: Tech firm markets higher surge pushes US</h2>
			<figure class="img_news">
			...
			# inicijalizacija sjednice
			$_SESSION['news_3'][0] = 'Hotel booking sites probed by consumer watchdog';
			$_SESSION['news_3'][1] = 'index.php?menu=' . $menu . '&action=3';
