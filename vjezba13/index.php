...
<body>
	...
	if (!empty($_SESSION['news_1']) || !empty($_SESSION['news_2']) || !empty($_SESSION['news_3'])) {
		print '
		<aside><h2 style="text-align:center">ZADNJE PREGLEDANO</h2>';
		foreach($_SESSION as $item){
			print '<a class="news-link" href="' . $item[1] . '">' . $item[0] . '</a>';
		}
		print '<a href="session-destroy.php" class="news-link">Pobriši</a>';
		print '
		</aside>';
	}
	print '
